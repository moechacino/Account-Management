...
export default function FolderPlus({className, height="16", width="16", fill="currentColor"}: { className?: string, height?:string, width?:string, fill? : string }){
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fill}
             className={cn("bi bi-folder-plus", className)} viewBox="0 0 16 16">
            <path
