...
export default function PlusCircleDotted({className, height="16", width="16", fill="currentColor", opacity="1"}: { className?: string, height?:string, width?:string, fill? : string, opacity? : string }){
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fill}
           opacity={opacity}  className={cn("bi bi-plus-circle-dotted", className)} viewBox="0 0 16 16">
            <path
